import svgsg    from 'scaffolding/sprite-generators/svg-sprite/gulp/tasks/sprite-generators/svg-sprite';
...
function generateSVGSprites( cb ) {
    ...
    let folders = app.fn.config.getFolders( app.config.vendor.svgsg.sprite_src );
